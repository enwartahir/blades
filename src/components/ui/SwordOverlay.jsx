...
export default function SwordOverlay({ sword, index }) {
  ...
  const stars = Array.from({ length: 5 }, (_, i) => (
    <span
      key={i}
      style={{
        color: i < sword.rarity ? "#ffcc44" : "#2a3a44",
        fontSize: "1rem",
        marginRight: "2px",
      }}
    >
  ...
  return (
    ...
    >
      <div
        id={`sword-overlay-${index}`}
        style={{ opacity: 0, maxWidth: "380px" }}
      >
        {/* Element badge */}
        <div
          style={{
        ...
        <Link
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.borderColor = elementColor;
            e.currentTarget.style.background = `${elementColor}14`;
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.borderColor = `${elementColor}55`;
