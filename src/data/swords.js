...
export const ELEMENT_LIGHT_COLORS = {
  Electro: '#9944ff',
  Anemo:   '#00ffaa',
  Hydro:   '#0088ff',
  Pyro:    '#ff4400',
...
export const SWORD_CAMERA_POSITIONS = [
  { x: 0,    y: 0,    z: 5   },  // hero
  { x: -1.5, y: 0.3,  z: 4.5 },  // bakufu    [0]
  { x: 1.8,  y: -0.2, z: 4.2 },  // boreas    [1]
  { x: -2,   y: 0.5,  z: 5   },  // cool steel [2]
  { x: 0.5,  y: -0.5, z: 4.8 },  // dull blade [3]
  { x: -1,   y: 0.8,  z: 4   },  // freedom sworn [4]
  { x: 2,    y: 0,    z: 4.5 },  // katana    [5]
  { x: -1.8, y: -0.3, z: 5   },  // lions roar [6]
  { x: 0,    y: 0.6,  z: 4.2 },  // mistsplitter [7]
  { x: 1.5,  y: 0.2,  z: 4.8 },  // narukami  [8]
  { x: -0.5, y: -0.4, z: 4.5 },  // prototype [9]
]
